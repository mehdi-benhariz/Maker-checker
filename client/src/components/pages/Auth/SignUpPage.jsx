...
const SignUpPage = () => {
  ...
  async function handlRegister(e) {
    e.preventDefault();
    if (user.password.localeCompare(user.passwordConfirm) !== 0)
      return setErrors({ passwordConfirm: ["Passwords do not match"] });
